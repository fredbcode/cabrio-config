CC=gcc
BIN_DIR=/usr/bin
DATA_DIR=/usr/share/cabrio-config
...
cabrio-config: main.o ogl.o sdl_wrapper.o config.o bg.o menu.o game_sel.o \
...
install: cabrio-config
	...
	$(INSTALL) -m 755 -t $(BIN_DIR) cabrio-config
...
clean:
	rm -f cabrio-config *.o core core.*
